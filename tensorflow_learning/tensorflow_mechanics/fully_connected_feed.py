"""
Train and evaluate the MNIST network using a feed dictionary.
"""
import argparse
import os
import sys
...
def fill_feed_dict(data_set, image_pl, labels_pl):
    ...
    feed_dict = {image_pl: images_feed, labels_pl: labels_feed}
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--input_data_dir',
        type=str,
        default='E:/mycode/python/tensorflowTest/mnistr/data',
